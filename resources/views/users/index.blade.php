                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('users.show', ['id' => $user->id]) }}">
                                        <i class="material-icons more" title="Show">&#xe619;</i>
                                    </a>
                                    <a href="{{ route('users.edit', ['id' => $user->id]) }}" class="edit">
                                        <i class="material-icons" title="Edit">&#xE254;</i>
                                    </a>

                                    <a href="#deleteEmployeeModal{{ $user->id }}" class="delete"
                                        data-toggle="modal">
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('users.destroy', ['id' => $user->id]) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to delete "{{ $user->name }}'s"
                                                            record?</p>
